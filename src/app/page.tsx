 ...
 */
const Header = () => (
  <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gold/20 py-8" style={{ backgroundImage: "url('/images/carbonfiber.png')", backgroundSize: '300px 300px', backgroundColor: 'rgba(244, 244, 245, 0.7)', backgroundBlendMode: 'multiply' }}>
            ...
            >
              ...
              <div className="relative w-full h-full rounded-lg overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-4 left-4 flex flex-col gap-1">
                  <div className="font-dm-mono text-xs text-gold bg-black/70 px-3 py-1 rounded">
                    {story.number}
                  </div>
 ...
 */
const Footer = () => (
  <footer className="bg-white border-t border-gold/20" style={{ backgroundImage: "url('/images/carbonfiber.png')", backgroundSize: '300px 300px', backgroundColor: 'rgba(244, 244, 245, 0.7)', backgroundBlendMode: 'multiply' }}>
...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="relative w-screen">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center bg-white bg-cover bg-center" style={{ backgroundImage: "url('/images/carbonfiber.png')" }}>
